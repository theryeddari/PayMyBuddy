...
public class TransactionControllerIT {
    ...
    public void testGetTransferredGeneralDetail_Success() throws Exception {
        TransferredGeneralDetailDTO transferredGeneralDetailDTO1 = new TransferredGeneralDetailDTO("alice@example.com", "Payment for service", 20.00);
    ...
    public void testAggregationNecessaryInfoForTransfer_Success() throws Exception {
        ...
        TransferredGeneralDetailDTO transferredGeneralDetailDTO1 = new TransferredGeneralDetailDTO("alice@example.com", "Payment for service", 20.0);
